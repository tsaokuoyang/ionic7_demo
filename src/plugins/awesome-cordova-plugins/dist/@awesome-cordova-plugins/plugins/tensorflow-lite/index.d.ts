 ...
 * ```
 */
export declare class TensorFlowLitePluginOriginal extends AwesomeCordovaNativePlugin {
    /**
...
export declare const TensorFlowLitePlugin: TensorFlowLitePluginOriginal;